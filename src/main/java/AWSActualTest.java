...
public class AWSActualTest {
    ...
    private static Object fromString(){
        // Deserializing a putObjectRequest I serialized from our internal repo codebase. It doesn't set a ton of state,
        // but I decided this was better than paring down the mountain of java code we have in our local repo
